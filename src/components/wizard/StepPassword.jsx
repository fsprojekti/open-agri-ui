// file: src/components/wizard/StepPassword.jsx
...
export function PasswordStep({
                                 ...
                                 minLength = 6,
                                 validate,                // (v) => "" | "error"
                                 normalize = (v) => v,    // don't trim password by default
                                 helpText,
                                 autoFocus = true,
                                 id = "passwordField",
                                 title = "Register",
    ...
    const submit = () => {
        ...
        if (v.length < minLength) return setErr(`At least ${minLength} characters`);
        if (validate) {
